...
package com.asadullah.criticalnewsapp.features.biometric.presentation
...
fun BiometricPrompt(
    ...
    val biometricPrompt = remember { BiometricPrompt(context as FragmentActivity, executor, callback) }
